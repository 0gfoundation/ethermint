...
// FeeMarketQueryClient is an autogenerated mock type for the FeeMarketQueryClient type
...
// SuggestionGasPrice provides a mock function with given fields: ctx, in, opts
func (_m *FeeMarketQueryClient) SuggestionGasPrice(ctx context.Context, in *types.QuerySuggestionGasPriceRequest, opts ...grpc.CallOption) (*types.QuerySuggestionGasPriceResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for SuggestionGasPrice")
	}

	var r0 *types.QuerySuggestionGasPriceResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *types.QuerySuggestionGasPriceRequest, ...grpc.CallOption) (*types.QuerySuggestionGasPriceResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *types.QuerySuggestionGasPriceRequest, ...grpc.CallOption) *types.QuerySuggestionGasPriceResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*types.QuerySuggestionGasPriceResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *types.QuerySuggestionGasPriceRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
